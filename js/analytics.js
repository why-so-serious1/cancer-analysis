(function() {
    ...
    ;(function() {
        ...
        var c = function(a) {
        ...
        }, e = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i, g = window, ca = /:[0-9]+$/, l = function(a, b) {
            var d = function(a) {
            ...
            for (var e = "", g = 0; ; ) {
                ...
                if (64 === ve && -1 === ca)
                    return e;
                e += String.fromCharCode(ca << 2 | l >> 4);
                64 != ze && (e += String.fromCharCode(l << 4 & 240 | ze >> 2),
                64 != ve && (e += String.fromCharCode(ze << 6 & 192 | ve)))
            }
            ...
            g.history && g.history.replaceState && (ye.test(b) || ye.test(c)) && (a = l(a, "path"),
            b = d(b, "?"),
            c = d(c, "#"),
            g.history.replaceState({}, void 0, "" + a + b + c))
        }, Be = function(a) {
            var b = void 0 === b ? 3 : b;
            try {
                if (a) {
                    ...
                    if (c && "1" === c[1]) {
                        ...
                        a: {
                            for (a = 0; a < b; ++a) {
                                ...
                                var g = a;
                                g = void 0 === g ? 0 : g;
                                var ca = [window.navigator.userAgent, (new Date).getTimezoneOffset(), window.navigator.xa || window.navigator.language, Math.floor((new Date).getTime() / 60 / 1E3) - g, e].join("*"), l;
                                if (!(l = ue)) {
                                    var w = Array(256);
                                    for (g = 0; 256 > g; g++) {
                                        for (var k = g, da = 0; 8 > da; da++)
                                ...
                                for (k = 0; k < ca.length; k++)
                                    g = g >>> 8 ^ ue[(g ^ ca.charCodeAt(k)) & 255];
                                c = (g ^ -1) >>> 0;
                                if (d === c.toString(36)) {
                                    var te = !0;
                                    break a
            ...
            if (c = c.data)
                ...
                a && d(b, c.ea);
            return b
        }, xe = ["google_tag_data", "glBridge", "get"], da = this;
        xe[0]in da || "undefined" == typeof da.execScript || da.execScript("var " + xe[0]);
    ...
    var oe = function() {
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j69", "sr=1"],
        b && a.push("_f=" + b),
      ...
      , Jc = function(a, b) {
        ...
        c || e))
            ...
            a.get(bc)) {
                ...
                d._gid && (J(51),
                a.data.set(I, d._gid)),
                d._gac && (d = d._gac.split(".")) && 2 == d.length && (J(37),
                a.data.set(ce, d[0]),
                a.data.set(fe, d[1]))),
                c)
                    b: if (d = c.indexOf("."),
